        ...
        for($i = 0; $i < 1; $i++) {
            DB::table('books')->insert([
                [
                    ...
                    'author' => 'Harper Lee',
                    'image_url' => 'https://images-na.ssl-images-amazon.com/images/P/0446310786.01._SX360_SCLZZZZZZZ_.jpg',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                ...
                [
                    ...
                    'image_url' => 'https://images-na.ssl-images-amazon.com/images/P/0743297334.01._SX360_SCLZZZZZZZ_.jpg',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                ...
                [
                    ...
                    'author' => 'Emily Brontë',
                    'image_url' => 'https://images-na.ssl-images-amazon.com/images/P/0141439556.01._SX360_SCLZZZZZZZ_.jpg',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    ...
                    'image_url' => 'https://images-na.ssl-images-amazon.com/images/P/0618640150.01._SX360_SCLZZZZZZZ_.jpg',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    ...
                    'image_url' => 'https://images-na.ssl-images-amazon.com/images/P/0679723161.01._SX360_SCLZZZZZZZ_.jpg',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
            ]);
