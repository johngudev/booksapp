...
Route::middleware('auth')->post('/api/meetings/join/{meeting}',[MeetingController::class, 'linkToUser']);
Route::middleware('auth')->delete('/api/meetings/join/{meeting}',[MeetingController::class, 'unlinkFromUser']);
